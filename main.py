...
class summarize_text:
    def __init__(self,articles,max_summary_len=22,max_num_culsters = 14):
        # Input, single article or list of articles
        # and the maximun number of sentences for the summary
        self.article = articles
        self.max_summary_len = max_summary_len
        self.max_num_culsters = max_num_culsters
    ...
    def single_article(self):
        ...
        clusters, cluster_centers = functions.cluster_sents(df_article['Embendings'],self.max_num_culsters)
...
if __name__ == '__main__':
    ...
    summary = summarize_text(articles,max_summary_len=22)
